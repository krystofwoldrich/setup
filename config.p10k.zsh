# Generated by Powerlevel10k configuration wizard on 2023-11-05 at 18:17 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 42599.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, round separators, sharp heads, round tails, 2 lines, disconnected,
# full frame, light-ornaments, sparse, many icons, concise, instant_prompt=verbose.
